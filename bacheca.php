                            ...
                            <li class="collection-item avatar">
                                ...
                                <?php if (isset($bacheca[$x]['allegati'][0])) {
                                    for($i = 0; $i < count($bacheca[$x]['allegati']); $i++) { ?>
                                        <p><b>Allegato:</b> <a target="_blank" href="<?= "http://www.portaleargo.it/famiglia/api/rest/messaggiobachecanuova?id=FFF" . $codice . "EEEII" . str_pad($i + 1, 5 ,"0", STR_PAD_LEFT) . str_pad($bacheca[$x]['allegati'][$i]['prgMessaggio'], 10 ,"0", STR_PAD_LEFT) . str_replace('-', '', $token) . "ax6542sdru3217t4eesd9"; ?>">
